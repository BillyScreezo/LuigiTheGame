	...
	while (!fin.eof())
	{
		...
		if (buff != "")
		{
			if (mode == "g:")
			{
				...
				if(array[4] != 9) ground_list.push_back(addNewObject_g(array[0], array[2], array[1], array[3], array[4], map));
				else ground_list.push_back(addNewObject_g(array[0], array[2], array[1], array[3], array[4], array[5], map));
			}
			else
			{
				for (size_t i = 0, prev_i = -1, count = 1, c = 0; i <= buff.size(); i++, count++)
				{
					if (buff[i] == ':' || i == buff.size())
					{
						...
						{
							if (strcmp(dig, "GOOMBA") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::GOOMBA, map, ground_list));
							else if (strcmp(dig, "KOOPA") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::KOOPA, map, ground_list));
							else if (strcmp(dig, "FLYKOOPA") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::FLYKOOPA, map, ground_list));
							else if (strcmp(dig, "PLANT") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::PLANT, map, ground_list));
							else if (strcmp(dig, "SFIRE") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::SFIRE, map, ground_list));
							else if (strcmp(dig, "STAR") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::STAR, map, ground_list));
							else if (strcmp(dig, "MUSHROOM") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::MUSHROOM, map, ground_list));
							else if (strcmp(dig, "LIVEMUSHROOM") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::LIVEMUSHROOM, map, ground_list));
							else if (strcmp(dig, "FLOWER") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::FLOWER, map, ground_list));
							else if (strcmp(dig, "COIN") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::COIN, map, ground_list));
							else if (strcmp(dig, "BOSS") == 0) enemy_list.push_back(addNewObject_e(arr[0], arr[1], EnemyType::BOSS, map, ground_list));
							arr[0] = -10100.0f;
							arr[1] = -10100.0f;
							count = 0;
							prev_i = i;
						...
						if (arr[0] == -10100.0f) arr[0] = (float)atoi(dig);
						else
						{
							if (arr[1] == -10100.0f) arr[1] = (float)atoi(dig);
							count = 0;
							prev_i = i;
							delete[] dig;
							continue;
		...
		case '1':
			...
			case 0:
				...
				else
				{
					...
					else
					{
						...
						{
							type = atoi(buff);
							if(type != 9) ground_list.push_back(addNewObject_g(0, 0, width, height, type, map));
							else ground_list.push_back(addNewObject_g(0, 0, width, height, type, 0, map));
			...
			case 1:
				...
				while (!isend3)
				{
					...
					if (GetKeyState(VK_RIGHT) < 0)
					{
						if (enemy_type == 10) enemy_type = 0;
						else enemy_type++;
					}
					if (GetKeyState(VK_LEFT) < 0)
					{
						if (enemy_type == 0) enemy_type = 10;
						else enemy_type--;
					}
					if (_getch() == 13)
					{
			...
			if (g_index >= 0 || e_index >= 0)
			{
				...
				case 0:
					...
					while (!isend3)
					{
						...
						if (GetKeyState(VK_LEFT) < 0)
						{
							if (g_index == 0) g_index = static_cast<int>(ground_list.size()) - 1;
							else g_index--;
						}
						if (GetKeyState(VK_RIGHT) < 0)
						{
							if (g_index == ground_list.size() - 1) g_index = 0;
							else g_index++;
						}
						if (_getch() == 13)
						{
				...
				case 1:
					...
					if(enemy_list.size() != 0)
					{
						while (!isend3)
						{
							...
							if (GetKeyState(VK_LEFT) < 0)
							{
								if (e_index == 0) e_index = static_cast<int>(enemy_list.size()) - 1;
								else e_index--;
							}
							if (GetKeyState(VK_RIGHT) < 0)
							{
								if (e_index == enemy_list.size() - 1) e_index = 0;
								else e_index++;
							}
							if (_getch() == 13)
							{
								...
								while (!isend4)
								{
									...
									if (strcmp(buff, "GOOMBA") == 0)
									{
										...
										enemy_list[e_index]->setType(EnemyType::KOOPA); break;
									}
									else if (strcmp(buff, "FLYKOOPA") == 0) {
										enemy_list[e_index]->setType(EnemyType::FLYKOOPA); break;
									}
									else if (strcmp(buff, "PLANT") == 0) {
										enemy_list[e_index]->setType(EnemyType::PLANT); break;
									}
									else if (strcmp(buff, "SFIRE") == 0) {
										enemy_list[e_index]->setType(EnemyType::SFIRE); break;
									}
									else if (strcmp(buff, "STAR") == 0) {
										enemy_list[e_index]->setType(EnemyType::STAR); break;
									}
									else if (strcmp(buff, "MUSHROOM") == 0) {
										enemy_list[e_index]->setType(EnemyType::MUSHROOM); break;
									}
									else if (strcmp(buff, "LIVEMUSHROOM") == 0) {
										enemy_list[e_index]->setType(EnemyType::LIVEMUSHROOM); break;
									}
									else if (strcmp(buff, "FLOWER") == 0) {
										enemy_list[e_index]->setType(EnemyType::FLOWER); break;
									}
									else if (strcmp(buff, "COIN") == 0) {
										enemy_list[e_index]->setType(EnemyType::COIN); break;
									}
									else if (strcmp(buff, "BOSS") == 0) {
										enemy_list[e_index]->setType(EnemyType::BOSS); break;
									}
									else if (strcmp(buff, "nothing") == 0) break;
									else
									{
										system("cls");
				...
				if (GetKeyState(VK_ESCAPE) < 0) isend3 = true;
				Sleep(100);
			}
			else
			{
...
bool visualWorkSpace(vector<Ground*>& ground_list, vector<Enemy*>& enemy_list, int& pos, Map& map)
{
	...
	while (!isend)
	{
		...
		if (GetKeyState('Q') < 0 && g_index < 0)
		{
			...
			if (g_index <= g_prev_index && !g_ischange) g_index = -1;
			g_prev_index = g_index;
			if (e_index <= e_prev_index && !e_ischange) e_index = -1;
			e_prev_index = e_index;
			flag = true;
			if (ground_list.size() == 0 && enemy_list.size() == 0) flag = false;
		}
		if (g_index >= 0)
		{
			if (GetKeyState('W') < 0) ground_list[g_index]->setCoord(ground_list[g_index]->fx1, ground_list[g_index]->fx2, static_cast<float>(ground_list[g_index]->y1 - 1), static_cast<float>(ground_list[g_index]->y2 - 1));
			if (GetKeyState('S') < 0) ground_list[g_index]->setCoord(ground_list[g_index]->fx1, ground_list[g_index]->fx2, static_cast<float>(ground_list[g_index]->y1 + 1), static_cast<float>(ground_list[g_index]->y2 + 1));
			if (GetKeyState('A') < 0) ground_list[g_index]->setCoord(ground_list[g_index]->fx1 - 1.0f, ground_list[g_index]->fx2 - 1.0f, static_cast<float>(ground_list[g_index]->y1), static_cast<float>(ground_list[g_index]->y2));
			if (GetKeyState('D') < 0) ground_list[g_index]->setCoord(ground_list[g_index]->fx1 + 1.0f, ground_list[g_index]->fx2 + 1.0f, static_cast<float>(ground_list[g_index]->y1), static_cast<float>(ground_list[g_index]->y2));
		...
		if (e_index >= 0)
		{
			if (GetKeyState('W') < 0) enemy_list[e_index]->setCoord(enemy_list[e_index]->getX(), enemy_list[e_index]->getY() - 1);
			if (GetKeyState('S') < 0) enemy_list[e_index]->setCoord(enemy_list[e_index]->getX(), enemy_list[e_index]->getY() + 1);
			if (GetKeyState('A') < 0) enemy_list[e_index]->setCoord(enemy_list[e_index]->getX() - 1, enemy_list[e_index]->getY());
			if (GetKeyState('D') < 0) enemy_list[e_index]->setCoord(enemy_list[e_index]->getX() + 1, enemy_list[e_index]->getY());
			if (GetKeyState(VK_CONTROL) < 0)
			{
				g_ischange = false;
				g_index = -1;
		...
		if (GetKeyState(VK_ESCAPE) < 0) isend = true;
		if (GetKeyState(VK_LEFT) < 0)
		{
			for (size_t i = 0; i < ground_list.size(); i++)
	...
	while (!isend)
	{
		...
		case '2':
			...
			else
			{
				...
				for (size_t i = 0; i < ground_list.size(); i++)
				{
					if (ground_list[i]->getType() == 3) ground_list[i]->setSum('*');
				}
		...
		case '3':
			while (true)
			{
				...
				if (GetKeyState(VK_LEFT) < 0) iex--;
				if (GetKeyState(VK_RIGHT) < 0) iex++;
				if (_getch() == 13) break;
				if (iex < 0) iex = 2;
				if (iex > 2) iex = 0;
				Sleep(10);
